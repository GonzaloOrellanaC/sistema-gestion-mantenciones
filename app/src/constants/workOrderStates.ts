// Canonical state values returned by the server (English)
...
// Map canonical server state -> i18n translation key
...
export function getLocaleKeyForState(s: WorkOrderStateValue) {
  return STATE_TO_LOCALE_KEY[s] || s;
}
