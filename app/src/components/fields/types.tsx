...
export interface FieldProps {
  ...
  photos?: Record<string, string | { url?: string }>;
  ...
  dynamicLists?: Record<string, Array<{ type: 'text' | 'image'; value: string | { url?: string }; name?: string }>>;
  setDynamicLists?: React.Dispatch<React.SetStateAction<Record<string, Array<{ type: 'text' | 'image'; value: string | { url?: string }; name?: string }>>>>;
