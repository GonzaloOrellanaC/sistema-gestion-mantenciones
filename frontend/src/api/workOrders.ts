 ...
 */
export async function createWorkOrder(payload: { templateId: string; data?: unknown; scheduledStart?: string; assigneeId?: string; assigneeRole?: string }): Promise<WorkOrder> {
