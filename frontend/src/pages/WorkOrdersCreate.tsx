              ...
              <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 6 }}>
                  {daysInMonth.map(day => {
                    ...
                    return (
                      <div key={key} onClick={() => pickDate(day)} style={{ minHeight: 72, padding: 8, border: selected ? '2px solid #1976d2' : '1px solid #e0e0e0', borderRadius: 6, cursor: 'pointer', background: selected ? '#E8F0FE' : undefined }}>
