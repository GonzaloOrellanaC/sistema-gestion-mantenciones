...
const RepuestoSchema = new mongoose_1.Schema({
    ...
    lotId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Lot' },
...
exports.default = mongoose_1.default.model('Repuesto', RepuestoSchema);
