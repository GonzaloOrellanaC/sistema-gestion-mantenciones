...
const TemplateSchema = new mongoose_1.Schema({
    ...
    structure: { type: mongoose_1.Schema.Types.Mixed, required: true },
    execWindowMinDays: { type: Number, default: 0 },
    execWindowMaxDays: { type: Number, default: 7 },
    expectedDurationDays: { type: Number, default: 1 },
    previewConfigs: { type: mongoose_1.Schema.Types.Mixed },
    assignedAssets: { type: [mongoose_1.Schema.Types.ObjectId], ref: 'Asset', default: [] },
    templateTypeId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'TemplateType' },
