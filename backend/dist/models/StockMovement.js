...
const StockMovementSchema = new mongoose_1.Schema({
    ...
    partId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Part', required: true, index: true },
    warehouseId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Warehouse' },
    toWarehouseId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Warehouse' },
...
exports.default = mongoose_1.default.model('StockMovement', StockMovementSchema);
